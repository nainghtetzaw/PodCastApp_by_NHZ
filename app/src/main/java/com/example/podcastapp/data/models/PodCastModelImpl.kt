...
//    }
    ...
    override fun getGenrePodCastData(
        ...
        mFirebaseApi.getAllPodCastGenreFromFirebase(onSuccess,onError)
    }

    override fun getUpNextPodCastData(onSuccess: (upnext: List<UpNextVO>) -> Unit,onError: (String) -> Unit) {
